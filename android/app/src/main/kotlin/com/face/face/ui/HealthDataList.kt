...
import com.face.face.utils.GENERAL_WELLNESS_SCORE
            ...
            dynamicMap["BP_SYSTOLIC"]?.let { systolic ->
                ...
                dynamicMap["HBA1C_RISK_PROB"]?.let {
                    ...
                    IndoCommonCard(
                        ...
                        isLowGood = true,
                        vitalStatus = HealthStatusEvaluator.evaluateHoemoglobinA1CRiskStatus(
                            riskProb
                        )
                    )
                }
...
//                    Row {
                    ...
                    dynamicMap["MENTAL_SCORE"]?.let {
                        ...
                        IndoCommonCard(
                            ...
                            vitalStatus = HealthStatusEvaluator.evaluateMentalStressIndexStatus(
                                numericValue
                            )
                        )
                    }
                    ...
                    dynamicMap["MSI"]?.let {
                        ...
                        dynamicMap["BP_TAU"]?.let {
                            ...
                            IndoCommonCard(
                                ...
                                vitalStatus = HealthStatusEvaluator.evaluateVascularCapacityStatus(
                                    formatted
                                )
                            )
                        }
                    ...
                    dynamicMap["HRV_SDNN"]?.let {
                        ...
                        IndoCommonCard(
                            ...
                            vitalStatus = HealthStatusEvaluator.evaluateHeartRateVariabilityStatus(
                                formatted
                            )
                        )
                    }
