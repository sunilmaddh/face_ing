...
import com.face.face.ui.HealthResultActivity
import com.face.face.utils.KEY_DFX_EXTRACTION_LIBRARY_STUDY_CONFIG
 ...
 */
class FaceAnuraMeasurementActivity :
    AppCompatActivity(),
     ...
     */
    private var deepAffexExtractionLibraryStudyConfigData by SharedPreferencesHelper(
        KEY_DFX_EXTRACTION_LIBRARY_STUDY_CONFIG,"")
//            by SharedPreferencesHelper(KEY_DFX_EXTRACTION_LIBRARY_STUDY_CONFIG, "")
    ...
    private fun handleMeasurementResultsComplete(results: MeasurementResults) {
        ...
        /**
         * Display MeasurementResults in a new [FaceResultsActivity] by sending it as extras in
         * the intent
         */
...
//        var measurementQuestionnaire = MeasurementQuestionnaire()
        val status = measurementPipeline.startMeasurement(
           FaceStartActivity.Companion.measurementQuestionnaire ,BuildConfig.DFX_STUDY_ID,
            FaceStartActivity.Companion.PARTNER_ID
        )
...
//    }
    ...
    private fun setupMeasurementView() = runOnUiThread {
        ...
        with(measurementView.tracker) {
            ...
            setListener(this@FaceAnuraMeasurementActivity)
        }
    }
