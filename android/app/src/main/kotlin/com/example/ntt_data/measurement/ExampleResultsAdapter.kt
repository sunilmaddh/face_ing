...
package ai.nuralogix.anura.sample.ui.measurement
 ...
 */
class ExampleResultsAdapter(private val results: MeasurementResults) :
    RecyclerView.Adapter<ExampleResultsAdapter.ResultsViewHolder>() {
