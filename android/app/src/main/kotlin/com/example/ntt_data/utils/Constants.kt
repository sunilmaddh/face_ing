...
internal  const val general_health_des="The Wellness Score is a prediction risk score that is used to predict a person's cardiovascular risk for the next 5 to 10 years. "
internal  const val BREATHIN_RATW_DIS="The number of breaths you take per minute. "
internal const val HEART_RATE="Number of heartbeats per minute. Normal resting rate is 60 to 100."
...
internal const val BLOOD_PRESSURE_SY_DIS="Your Blood Pressure Systolic Index is Mild"
internal  const val BLOOD_PRESSURE_DI_DIS="Your Blood Pressure Diastolic Index is Mild"
internal  const val  IRREGULAR_HEART_DIS="Face.ing Irregular Heartbeats estimates the number detected in 30 seconds via facial blood-flow analysis (TOI)."
internal const val HEMOGLOBIN_A1_DIS="Hemoglobin A1C (or HbA1c) represents the average blood glucose (sugar) level for the last two to three months."
internal const val FASTING_GLUCOSE_RISK_DIS="The High Fasting Glucose Risk result indicates whether your glucose level exceeds a preset threshold after at least 8 hours of fasting. "
internal const val CARD_DISEA_RISK_DIS="Cardiovascular Disease Risk is the subject's 10-year likelihood (%) of a first heart attack or stroke."
internal  const val HEART_ATTACK_RISK_DIS="Heart Attack Risk is the subject's 10-year likelihood (%) of a first heart attack."
...
internal const val HYPERTRIGLY_EMIA_RISK_DIS="Hypertriglyceridemia Risk is the % of similar individuals with triglyceride levels above 1.7 mmol/L (150 mg/dL)."
internal const val MENTAL_SCORE_DIS="Mental Stress is a 5-point proprietary score from relaxed (1) to overloaded (5)."
...
internal const val S_N_R_Description="Type 2 Diabetes Risk corresponds to the percentage of people with the subject's risk profile who are diagnosed with Type 2 Diabetes by their doctor."
