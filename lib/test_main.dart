...
import 'package:ntt_data/binah_sdk/measurement_model.dart';
import 'package:ntt_data/binah_sdk/widget_size.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: const MaterialApp(home: SafeArea(child: MeasurementScreen())),
    );
  }
}
...
class MeasurementScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var warning = context.select<MeasurementModel, String?>(
      (model) => model.warning,
    );
    var error = context.select<MeasurementModel, String?>(
      (model) => model.error,
    );
    var finalResults = context.select<MeasurementModel, String?>(
      (model) => model.finalResultsString,
    );
...
class _CameraPreviewState extends State<_CameraPreview> {
  ...
  @override
  Widget build(BuildContext context) {
    var sessionState = context.select<MeasurementModel, SessionState?>(
...
class _StartStopButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var state = context.select<MeasurementModel, SessionState?>(
      (model) => model.sessionState,
    );
    var opacity =
    ...
    return Opacity(
      ...
      child: InkWell(
        ...
        onTap: () {
          var measurementModel = Provider.of<MeasurementModel>(
            context,
            listen: false,
          );
...
class _PulseRate extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var pulseRate = context.select<MeasurementModel, String?>(
      (model) => model.pulseRate,
    );
    return Text(
      pulseRate ?? "",
...
class _ImageValidity extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var showImageValidity = context.select<MeasurementModel, bool>(
      (model) => model.showImageValidity,
    );
    var imageValidityString = context.select<MeasurementModel, String>(
      (model) => model.imageValidityString,
    );
