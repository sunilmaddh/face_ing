...
class OnboardingPageView extends StatelessWidget {
   const OnboardingPageView({super.key,required this.image, required this.title, required this.description});
                    ...
                    children: [
                      ...
                      Text(
                       description,
                        ...
                        style: AppTextStyles.smallText(color: AppColors.descriptionColor,fontWeight: FontWeight.w400)
                      ),
                    ],
                  ),
    );
