                        ...
                        child: Column(
                          children: [
                            ...
                            CommonDropdownTextField(
                              ...
                              controller: _geustController.weightTextController,
                            ),
                          ...
                          child: ScanButton(
                            onPressed: () async {
                              if (_formKey.currentState!.validate()) {
                                if (_geustController.selectionType.isEmpty) {
                                  AppSnackbar.show(
                                    isError: true,
                                    title: "Error",
                                    message: "Please select gender",
                                  );
                                } else if (controller.selectionType.isEmpty) {
                                  AppSnackbar.show(
                                    isError: true,
                                    title: "Error",
                                    message: "Please select Smoker type",
                                  );
                                } else if (_geustController.isChecked.isFalse) {
                                  AppSnackbar.show(
                                    isError: true,
                                    title: "Error",
                                    message:
