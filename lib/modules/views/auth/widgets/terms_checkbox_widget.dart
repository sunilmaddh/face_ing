...
class TermsCheckboxWidget extends StatelessWidget {
  ...
  const TermsCheckboxWidget({super.key, required this.authController, required this.message,});
  ...
  side: BorderSide(color: AppColors.checkBoxBorderColor, width: 1), // Border color
),
          ...
          Flexible( // Ensures text does not overflow
            child: Padding(
              ...
              child: Text(
               message,
                style: TextStyle(fontSize: AppDimensions.font(14),fontWeight: FontWeight.w600,color: AppColors.termColor),
