      ...
      child: Padding(
        ...
        child: Align(
          ...
          child:InkWell(
            ...
            child: CommonAssets.svgAsset(AppAssets.homeMenu,width: 60,height: 60)), // Keeps at the start
        ),
            ),
            Expanded(
        ...
        child: Align(
          ...
          child: CommonAssets.svgAsset(AppAssets.faceLogo,) // Keeps in the center
        ),
            ),
       ...
       SizedBox(height: AppDimensions.height(60),),
        ...
        CommonText.text(AppConstents.scanDiscri,fontSize: AppDimensions.font(18),fontWeight: FontWeight.w500,maxLines: 2,textAlign: TextAlign.center),
        SizedBox(height:110,),
        ScanButton(
          width: 193,
           onPressed: (){
