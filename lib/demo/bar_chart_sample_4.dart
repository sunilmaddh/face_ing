...
class BarChartSample4 extends StatefulWidget {
  ...
  final Color dark = AppColors.searchColor;
  final Color normal = AppColors.primary;
  final Color light = AppColors.historyCardColor;
        ...
        barRods: [
          ...
          BarChartRodData(
            ...
            rodStackItems: [
              ...
              BarChartRodStackItem(14, 2, AppColors.historyCardColor),
            ],
            borderRadius: BorderRadius.zero,
            width: barsWidth,
          ),
